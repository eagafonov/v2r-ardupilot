...
void AP_Baro_None::setHIL(float altitude_msl)
{
...
float AP_Baro_None::get_pressure() {
    return Press;
}

float AP_Baro_None::get_temperature() {
    return Temp;
}
