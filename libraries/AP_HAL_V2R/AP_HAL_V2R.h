...
#ifndef __AP_HAL_V2R_H__
#define __AP_HAL_V2R_H__

/* Your layer exports should depend on AP_HAL.h ONLY. */
#include <AP_HAL.h>

/**
 * Umbrella header for AP_HAL_V2R module.
 ...
 * names, headers) via the V2R namespace.
 * The class implementing AP_HAL::HAL should be called HAL_V2R and exist
 * in the global namespace. There should be a single const instance of the
 * HAL_V2R class called AP_HAL_V2R, instantiated in the HAL_V2R_Class.cpp
 * and exported as `extern const HAL_V2R AP_HAL_V2R;` in HAL_V2R_Class.h
 *
 * All declaration and compilation should be guarded by CONFIG_HAL_BOARD macros.
 * In this case, we're using CONFIG_HAL_BOARD == HAL_BOARD_V2R.
...
#include "AP_HAL_V2R_Main.h"

#endif //__AP_HAL_V2R_H__
