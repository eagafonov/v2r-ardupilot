...
class V2R::V2RUARTDriver : public AP_HAL::UARTDriver {
public:
    V2RUARTDriver(bool default_console);
    /* V2R implementations of UARTDriver virtual methods */
    ...
    /* V2R implementations of Stream virtual methods */
    int16_t available();
    int16_t txspace();
    int16_t read();
