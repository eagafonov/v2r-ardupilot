...
#ifndef __AP_HAL_V2R_I2CDRIVER_H__
#define __AP_HAL_V2R_I2CDRIVER_H__

#include <AP_HAL_V2R.h>

class V2R::V2RI2CDriver : public AP_HAL::I2CDriver {
public:
    V2RI2CDriver(AP_HAL::Semaphore* semaphore, const char *device);
...
#endif // __AP_HAL_V2R_I2CDRIVER_H__
