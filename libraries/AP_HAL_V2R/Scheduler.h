...
#ifndef __AP_HAL_V2R_SCHEDULER_H__
#define __AP_HAL_V2R_SCHEDULER_H__
...
#define V2R_SCHEDULER_MAX_TIMER_PROCS 10

class V2R::V2RScheduler : public AP_HAL::Scheduler {
public:
    V2RScheduler();
...
private:
    ...
    AP_HAL::MemberProc _timer_proc[V2R_SCHEDULER_MAX_TIMER_PROCS];
    uint8_t _num_timer_procs;
    volatile bool _in_timer_proc;

    AP_HAL::MemberProc _io_proc[V2R_SCHEDULER_MAX_TIMER_PROCS];
...
#endif // __AP_HAL_V2R_SCHEDULER_H__
