...
v2r: HAL_BOARD = HAL_BOARD_V2R
v2r: TOOLCHAIN = ARM_LINUX
v2r: all

v2r-native: HAL_BOARD = HAL_BOARD_V2R
v2r-native: TOOLCHAIN = NATIVE
v2r-native: all
...
BOARDS = apm1 apm2 apm2beta apm1-1280 px4 px4-v1 px4-v2 sitl flymaple linux v2r
